...
const DOCUMENT_SCHEMA={type:"object",additionalProperties:false,required:["resume","coverLetter","writersNotes"],properties:{resume:{type:"string"},coverLetter:{type:"string"},writersNotes:{type:"string"}}};
